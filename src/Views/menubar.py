...
def createMenuBar(parent):
    ...
    helpMenu.add_command(label="Reportar Problema",command=lambda: openBrowser("https://github.com/Knightleo602/LoginVault/issues"))
    helpMenu.add_command(label="Guia de usuario",command=lambda: openBrowser("https://github.com/Knightleo602/LoginVault/blob/main/README.md"))
    helpMenu.add_command(label="Pagina do Github",command=lambda: openBrowser("https://github.com/Knightleo602/LoginVault"))
